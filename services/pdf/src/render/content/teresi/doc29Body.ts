...
/** Documento 29 — Piano aziendale gestione del rischio (1A.06.02.01), struttura tipo Teresi. */
...
<h2>10. Riesame</h2>
<p>Il piano è aggiornato in caso di eventi straordinari, modifiche organizzative o impiantistiche, e almeno con la periodicità definita in sede di revisione del sistema documentale.</p>
